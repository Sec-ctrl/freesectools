...
TeaTimeTips = [
        ...
        "A Security Operations Center (SOC) is a centralized unit that monitors and analyzes an organization’s security posture, detecting and responding to cyber threats.",
        ...
        "Red teaming is a simulated attack exercise where security professionals attempt to breach an organization’s defenses to identify weaknesses.",
...
def home():
    ...
    } for item in cve_data[:10]]  # Limit to the first 10 CVEs
    return render_template('home.html', title='Home', cve_items=cve_data_short, tip_of_the_table=tip_of_the_table)
